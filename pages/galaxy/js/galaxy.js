...
//
//   azimuth f � horizontal rotation around the galaxy (fast-ish)
//   polar ?   � elevation from equator toward poles (slow, wide sweep)
//
...
//
//   f(t) = f_speed * t
//   ?(t) = ?_amp * sin(?_speed * t)         ? swings -?_amp � +?_amp
//
// Camera sits at: ( cos(f)�cos(?)�R,  sin(?)�R,  sin(f)�cos(?)�R )
